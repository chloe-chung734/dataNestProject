...
INSERT INTO ewha.customer_demographic_history (customer_id, city, age_range, gender, start_date, end_date) VALUES
  ...
  (1, 'Incheon', '20-29', 'Female', '2021-01-01', '2022-01-01'),
  (2, 'Seoul', '20-29', 'Male', '2020-06-01', '2022-01-01'),
  (3, 'Seoul', '10-19', 'Female', '2020-09-15', '2022-01-01'),
  (4, 'Seoul', '30-39', 'Male', '2021-02-01', '2022-01-01'),
  (5, 'Busan', '10-19', 'Female', '2020-12-01', '2022-01-01'),
  (6, 'Seoul', '20-29', 'Male', '2021-05-01', '2022-01-01'),
  (7, 'Seoul', '10-19', 'Female', '2020-03-15', '2022-01-01'),
  (8, 'Seoul', '40-49', 'Male', '2019-08-01', '2022-01-01'),
  (9, 'Seoul', '30-39', 'Female', '2021-11-01', '2022-01-01'),
  (10, 'Seoul', '20-29', 'Male', '2020-01-01', '2022-01-01'),
  (1, 'Busan', '20-29', 'Female', '2024-06-01', NULL),
  (2, 'Seoul', '30-39', 'Male', '2023-03-01', NULL),
  (4, 'Busan', '40-49', 'Male', '2024-01-01', NULL),
  (6, 'Incheon', '30-39', 'Male', '2024-05-15', NULL),
  (7, 'Gwangju', '20-29', 'Female', '2023-11-01', NULL),
  (8, 'Incheon', '50-59', 'Male', '2024-02-01', NULL),
  (9, 'Seoul', '40-49', 'Female', '2023-08-01', NULL),
  (3, 'Daegu', '20-29', 'Female', '2024-04-01', NULL),
  (5, 'Daegu', '10-19', 'Female', '2024-03-01', NULL),
  (10, 'Gwangju', '30-39', 'Male', '2023-07-01', NULL);
...
INSERT INTO ewha.menu_price_history (menu_item_id, old_price, new_price, change_date) VALUES
    ...
    (1, 7500.0, 8100.0, '2023-06-15'),
    (2, 10000.0, 10800.0, '2023-06-15'),
    (3, 7200.0, 7650.0, '2023-06-15'),
    (4, 18000.0, 19800.0, '2023-06-15'),
    (5, 5000.0, 5400.0, '2023-06-15'),
    (6, 3300.0, 3600.0, '2023-06-15'),
    (7, 15000.0, 16200.0, '2023-06-15'),
    (8, 6200.0, 6750.0, '2023-06-15'),
    (9, 8500.0, 9000.0, '2023-06-15'),
    (10, 6800.0, 7200.0, '2023-06-15'),
    (1, 7000.0, 7500.0, '2022-11-01'),
    (2, 9200.0, 10000.0, '2022-11-01'),
    (3, 6600.0, 7200.0, '2022-11-01'),
    (4, 16500.0, 18000.0, '2022-11-01'),
    (5, 4600.0, 5000.0, '2022-11-01'),
    (6, 3000.0, 3300.0, '2022-11-01'),
    (7, 13800.0, 15000.0, '2022-11-01'),
    (8, 5700.0, 6200.0, '2022-11-01'),
    (9, 7800.0, 8500.0, '2022-11-01'),
    (10, 6200.0, 6800.0, '2022-11-01'),
    (2, 8500.0, 9200.0, '2022-03-20'),
    (4, 15000.0, 16500.0, '2022-03-20'),
    (6, 2800.0, 3000.0, '2024-09-10'),
    (7, 17200.0, 18000.0, '2025-02-01'),
    (9, 9500.0, 10000.0, '2025-01-15'),
    (1, 9000.0, 9500.0, '2025-04-01'),
    (3, 8500.0, 9000.0, '2025-03-15'),
    (5, 6000.0, 6500.0, '2025-05-20'),
    (8, 7500.0, 8000.0, '2025-06-10'),
    (10, 8000.0, 8500.0, '2025-02-28');
